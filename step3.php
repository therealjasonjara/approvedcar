        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-step">
                    ...
                    <form id="commentForm" method="get" action="step4.php" class="form-horizontal">
                        <div class="steps-form-box">
                           <div class="stap-hading-text">
                               <h4>Choose Make & Model</h4>
                               <hr>
                           </div>
                                ...
                                <div class="form-group lbl-full-width label-p-left">
                                    <label for="income">
                                        ...
                                        <select class="form-control" id="income">
                                            <option value="">Aston Martin DB11 Coupe</option>
                                        </select>
                                    </label>
                                </div>
                            </div>
                            <div class="steps-btn">
                                <button type="submit" class="btn">COMPLETE FORM</button>
                            </div>
                        </div>
                    </form>
