        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-step">
                    ...
                    <form id="commentForm" method="get" action="step3.php" class="form-horizontal">
                        <div class="steps-form-box">
                           <div class="stap-hading-text">
                            ...
                            <div class="steps-form-box-main">
                                <div class="form-group lbl-half-width label-p-right">
                                    <label for="f_name">
                                        <div class="box2">
                                            <label>
                                                <input type="radio" name="cat" id="" value="PL">
                                                <span class="label-wrap">
                                                   <span class="radio-txt">New Car</span>
                                                </span>
                                            </label>
                                        </div> 
                                    </label>
                                    ...
                                    <label for="f_name">
                                        <div class="box2">
                                            <label>
                                                <input type="radio" name="cat" id="" value="PL">
                                                <span class="label-wrap">
                                                   <span class="radio-txt">Used Car</span>
                                                </span>
                                            </label>
                                        </div> 
                                    </label>
